...
public class CreateArrays {
	...
	final int MAXBRUTEFORCE = 26; // I am using same constant value for DP 
	...
	public ArrayList<ArrayList<Integer>> cA() {
	...
	while(noOfMatrix<2 || noOfMatrix > MAXBRUTEFORCE ) {
		System.out.println("Brute Force Test ( 2 - "+MAXBRUTEFORCE+" matrices) ");
